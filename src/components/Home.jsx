      ...
      <div name="Home" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-20">
        ...
        />
            ...
            <p className="text-sm md:text-md text-justify">
              ...
              dolorum non commodi ut quas omnis, velit quod, necessitatibus,
              repellat doloremque ipsa accusamus? Est, ab! Maiores temporibus
              iste, tempore obcaecati, placeat fuga molestias assumenda quis
              odio fugit a voluptatem!
            </p>
            <br />
            ...
            <div className="flex  flex-col  items-center md:flex-row justify-between space-y-6 md:space-y-0">
              ...
              <div className="space-y-2 ">
                <h1 className="font-bold text-green-500">Cureently Working On</h1>
